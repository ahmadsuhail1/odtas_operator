...
def rotate_gimbal():
    ...
    control_data = ControlData(roll_mode=0, roll_speed=0, roll_angle=0,
                               pitch_mode=1, pitch_speed=100, pitch_angle=45,
                               yaw_mode=1, yaw_speed=100, yaw_angle=45)
    ...
    # connection = serial.Serial('/dev/ttyUSB3', baudrate=115200, timeout=10)
    connection = serial.Serial(port = 'COM7', baudrate=115200, timeout=10)
